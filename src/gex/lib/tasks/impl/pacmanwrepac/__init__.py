'''Implementation of pacmanwrepac: Pac Man World Re Pac'''
import logging
import os
import lzma
...
class PacManWorldRePacTask(BaseTask):
    '''Implements pacmanwrepac: Pac Man World Re Pac'''
    _task_name = "pacmanwrepac"
    _title = "Pac Man World Re Pac"
    _details_markdown = ''''''
